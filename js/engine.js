...
GenericEntity.prototype.setTexture = function (textureName, totalTextureFrames) {
	this.textureName = textureName;
	this.totalTextureFrames = totalTextureFrames;
};

GenericEntity.prototype.setTextureFrame = function(textureFrame) {
	this.textureFrame = textureFrame;
};

GenericEntity.prototype.nextTextureFrame = function() {
	this.textureFrame++;
	this.textureFrame %= this.totalTextureFrames;
}
...
WorldRenderer.prototype.redraw = function() {
	...
	entities.forEach(function(entity, i, array) {
		if ((this.viewportX <= entity.getX()) && (this.viewportY <= entity.getY())) {
			ctx.drawImage(this.entityTextures[entity.textureName][entity.textureFrame], entity.getX() - this.viewportX, entity.getY() - this.viewportY);
		}
	}, this);
};
